...
def main(inputfile, outdir, model):
    train_auto(inputfile,outdir,model,0.3,30,25,32,2049,4096,512)
...
# python melody_separator/separate_bach10.py -i melody_separator/input/05-DieNacht_fast_complete.wav -o melody_separator/output -m /content/drive/MyDrive/melody_separator/model_fft_rwc_synth_one_aug_more_4096_blind_nomp_all.pkl